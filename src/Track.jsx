...
export function Track() {
  // Automtically suspends the component onto all assets downloaded
  ...
  const colorMap = useLoader(
    TextureLoader,
    process.env.PUBLIC_URL + "/pics/track.png"
  );

  //Helpt filtering van textuur when looking from grazed angles
  useEffect(() => {
    colorMap.anisotropy = 16;
  }, [colorMap]);

  // Every mesh in three js needs a geometry and a mesh
  // Hier nemen we geometry da in de gedownloadde mesh zat met de useLoader hook
